...
<div class="container">
    <div class="row flex-column-reverse flex-lg-row mt-8 mt-lg-6">
        <div class="col-lg-9 order-lg-2 ">
            <img class="rounded w-100 d-none d-md-block" src="<?= base_url() ?>assets/front/img/bannercreator.png" alt="">
        ...
        <aside class="col-lg-3">
            <div class="wrapper rounded-top d-block d-sm-none" style="height: 120px;background-image:url('<?= base_url() ?>assets/front/img/bannercreator.png');background-position: center;background-size: cover;"></div>
            <div class="bg-white rounded-bottom p-5 text-center">
                <img class="rounded-circle w-15" src="<?= base_url() ?>assets/front/img/avatars/apa.jpg" alt="" />
                ...
                <nav class="nav social justify-content-center">
                    <a href="#"><img src="<?= base_url() ?>assets/front/img/icons/social/twitter.svg" alt=""></a>
                    <a href="#"><img src="<?= base_url() ?>assets/front/img/icons/social/tiktok.svg" alt=""></a>
                    <a href="#"><img src="<?= base_url() ?>assets/front/img/icons/social/facebook.svg" alt=""></a>
                    <a href="#"><img src="<?= base_url() ?>assets/front/img/icons/social/globe.svg" alt=""></a> <!-- link web -->
                    <a href="#"><img src="<?= base_url() ?>assets/front/img/icons/social/instagram.svg" alt=""></a>
                    <a href="#"><img src="<?= base_url() ?>assets/front/img/icons/social/twitch.svg" alt=""></a>
                    <a href="#"><img src="<?= base_url() ?>assets/front/img/icons/social/youtube.svg" alt=""></a>
                </nav>
            </div>
            <div class="bg-white rounded mt-5 py-3 px-5">
                ...
                <p>Bergabung dalam kreativitas! Dukung [creator_alias] untuk konten inspiratif.</p>
                <!-- Else -->
                ...
                <ul class="progress-list mt-3">
                    <li>
                        ...
                        <p class="fs-12 mt-1"><span class="fw-bold">400.000</span> terkumpul dari 1.000.000</p>
                    </li>
                </ul>
                <!-- End if -->
...
<div class="modal fade" id="modal-subs" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content text-center">
            <div class="modal-body px-sm-10 px-6 py-5">
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                <img class="rounded-circle w-15 mb-4" src="<?= base_url() ?>assets/front/img/avatars/apa.jpg" alt="" />
                <p class="fs-18 text-navy">Creator Alias</p>
                <p class="fs-20 text-navy mt-n4"><span class="fw-bolder">Rp. 500.000</span>/Bln</p>
