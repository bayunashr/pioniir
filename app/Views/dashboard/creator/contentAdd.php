   ...
   <div class="content">
      <div class="block block-rounded">
         ...
         <div class="block-content block-content-full">
            <form action="<?= base_url('dashboard/content/add')?>" method="post">
               <div class="mb-4">
                  <label class="form-label" for="contentTitle">Title</label>
                  <input style="border-width: 0 0 1px 0; box-shadow:none; border-radius:0;" type="text" class="form-control" id="contentTitle" name="contentTitle" placeholder="Title" required>
               </div>
               <div class="mb-4">
                  <label class="form-label" for="contentPrice">Price</label>
                  <input style="border-width: 0 0 1px 0; box-shadow:none; border-radius:0;" type="number" class="form-control" id="contentPrice" name="contentPrice" placeholder="Price" required>
               </div>
               <div class="mb-3">
                  <label class="form-label" for="contentPreview">Preview (Thumbnail)</label>
                  <div class="banner mb-3">
                     <img style="width:400px; height:200px;" id="bannerView" src="<?= base_url() ?>assets/front/img/content.png" alt="">
                  ...
                  <input type="hidden" name="contentPreview" id="imageContent" required>
               </div>
               <div class="mb-4">
                  <label class="form-label" for="contentDownload">Downloadable File</label>
                  <input style="border-width: 0 0 1px 0; box-shadow:none; border-radius:0;" type="text" class="form-control" id="contentDownload" name="contentDownload" placeholder="External Link (example:https://drive.google.com/)" required>
               </div>
               <div class="mb-4">
                  <label class="form-label" for="contentValue">Description</label>
                  <!-- CKEditor Container -->
                  <textarea id="js-ckeditor" name="contentValue">Tulis sesuatu, masukkan gambar, sisipkan tautan.....</textarea>
               </div>
               <div class="mb-4">
                  <label class="form-label" for="contentStatus">Status</label>
                  <select class="form-select" id="contentStatus" name="contentStatus">
...
function initCropper() {
   ...
   potongButton.addEventListener('click', function() {
      ...
      document.getElementById('imageContent').value = dataURL;
   });
}
