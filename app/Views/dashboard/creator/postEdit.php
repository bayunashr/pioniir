            ...
            <div class="block-content block-content-full">
                <form action="<?= base_url('dashboard/post/edit/'.$post['postId']) ?>" method="post">
                    <div class="mb-4">
                        ...
                        <input value="<?= $post['postTitle'] ?>" style="border-width: 0 0 1px 0; box-shadow:none; border-radius:0;" type="text" class="form-control" id="postTitle" name="postTitle" placeholder="Title">
                    </div>
                    <div class="mb-4">
                        <label class="form-label" for="postValue">Post Content</label>
                        <!-- CKEditor Container -->
                        <textarea id="js-ckeditor" name="postValue"><?= $post['postValue'] ?></textarea>
                    </div>
                    <div class="mb-4">
