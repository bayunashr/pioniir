      ...
      <nav id="sidebar" aria-label="Main Navigation">
         ...
         <div class="content-header">
            ...
            <a class="fw-semibold text-dual" href="<?= base_url() ?>">
               ...
               <span class="smini-hide fs-5 tracking-wider row"><img class="col-sm-6 col-4"
                     src="<?= base_url() ?>assets/front/img/pioniirwhite.png" alt=""></span>
            </a>
            <!-- END Logo -->
            ...
            <div class="content-side">
               <ul class="nav-main">
                  <li class="nav-main-item">
                     <a class="nav-main-link <?= current_url(true)->getSegment(1) == 'dashboard' && current_url(true)->getSegment(2) == '' ? 'active' : '' ?>"
                  ...
                  <li class="nav-main-item">
                     <a class="nav-main-link <?= current_url(true)->getSegment(2) == 'profile' && current_url(true)->getSegment(3) == 'creator' ? 'active' : '' ?>"
                        href="<?= base_url('dashboard/profile/creator') ?>">
                  ...
                  <li class="nav-main-item">
                     <a class="nav-main-link <?= current_url(true)->getSegment(2) == 'post' ? 'active' : '' ?>"
                  ...
                  <li class="nav-main-item">
                     <a class="nav-main-link <?= current_url(true)->getSegment(2) == 'content' ? 'active' : '' ?>"
                        href="<?= base_url('dashboard/content') ?>">
                  ...
                  <li class="nav-main-item">
                     <a class="nav-main-link <?= current_url(true)->getSegment(2) == 'balance' ? 'active' : '' ?>"
                        href="<?= base_url('dashboard/balance') ?>">
                        <i class="nav-main-link-icon si si-wallet"></i>
                        <span class="nav-main-link-name">My Balance</span>
                     </a>
                  </li>
                  <li class="nav-main-item">
                     <a class="nav-main-link <?= current_url(true)->getSegment(2) == 'donate' ? 'active' : '' ?>"
                        href="<?= base_url('dashboard/donate') ?>">
                        <i class="nav-main-link-icon si si-present"></i>
                        <span class="nav-main-link-name">Donate</span>
                     </a>
                  </li>
                  <li class="nav-main-item">
                     <a class="nav-main-link <?= current_url(true)->getSegment(2) == 'milestone' ? 'active' : '' ?>"
                        href="<?= base_url('dashboard/milestone') ?>">
                  ...
                  <li
                     class="nav-main-item <?= ((current_url(true)->getSegment(2) == 'report') && (service('uri')->getTotalSegments() >= 3 && ((current_url(true)->getSegment(3) == 'content') || current_url(true)->getSegment(3) == 'post'))) ? 'open' : '' ?>">
                     ...
                     <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                           <a class="nav-main-link <?= ((service('uri')->getTotalSegments() >= 3 && current_url(true)->getSegment(3) == 'content')) ? 'active' : '' ?>"
                              href="<?= base_url('dashboard/report/content') ?>">
                              <span class="nav-main-link-name">Content</span>
                           </a>
                        </li>
                        <li class="nav-main-item">
                           <a class="nav-main-link <?= ((service('uri')->getTotalSegments() >= 3 && current_url(true)->getSegment(3) == 'post')) ? 'active' : '' ?>"
                              href="<?= base_url('dashboard/report/post') ?>">
                              <span class="nav-main-link-name">Post</span>
                           </a>
                        </li>
                  ...
                  <li
                     class="nav-main-item <?= ((current_url(true)->getSegment(2) == 'report') && (service('uri')->getTotalSegments() >= 3 && ((current_url(true)->getSegment(3) == 'subscribe') || current_url(true)->getSegment(3) == 'donate'))) ? 'open' : '' ?>">
                     <a class="nav-main-link nav-main-link-submenu" data-toggle="submenu" aria-haspopup="true"
                        aria-expanded="false" href="#">
                     ...
                     <ul class="nav-main-submenu">
                        <li class="nav-main-item">
                           <a class="nav-main-link <?= ((service('uri')->getTotalSegments() >= 3 && current_url(true)->getSegment(3) == 'subscribe')) ? 'active' : '' ?>"
                              href="<?= base_url('dashboard/report/subscribe') ?>">
                              <span class="nav-main-link-name">Subscribe</span>
                           </a>
                        </li>
                        <li class="nav-main-item">
                           <a class="nav-main-link <?= ((service('uri')->getTotalSegments() >= 3 && current_url(true)->getSegment(3) == 'donate')) ? 'active' : '' ?>"
                              href="<?= base_url('dashboard/report/donate') ?>">
                              <span class="nav-main-link-name">Donate</span>
                           </a>
                        </li>
            ...
            <div class="d-flex align-items-center">
               ...
               <div class="dropdown d-inline-block ms-2">
                  <button type="button" class="btn btn-sm btn-alt-secondary d-flex align-items-center"
                     ...
                     aria-expanded="false">
                     <img class="rounded-circle" src="<?= base_url() ?>assets/dashboard/media/avatars/avatar10.jpg"
                        alt="Header Avatar" style="width: 21px;">
                     <span class="d-none d-sm-inline-block ms-2">
                        <?= esc($creator['creatorAlias']) ?>
                     </span>
                  ...
                  <div class="dropdown-menu dropdown-menu-md dropdown-menu-end p-0 border-0"
                     ...
                     <div class="p-3 text-center bg-body-light border-bottom rounded-top">
                        <img class="img-avatar img-avatar48 img-avatar-thumb"
                           src="<?= base_url() ?>assets/dashboard/media/avatars/avatar10.jpg" alt="">
                        <p class="mt-2 mb-0 fw-medium">
                           <?= esc($user['userFullName']) ?>
                        </p>
                     </div>
                     <div class="px-2 pt-2">
                        <a class="dropdown-item d-flex align-items-center justify-content-between"
                           href="<?= base_url('explore') ?>">
                           <span class="fs-sm fw-medium">Exit Dashboard</span>
                        </a>
                     </div>
         ...
         <div class="content py-3">
            <div class="row fs-sm">
               ...
               <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
                  <a class="fw-semibold" href="https://1.envato.market/AVD6j" target="_blank">OneUI 5.7</a> &copy; <span
